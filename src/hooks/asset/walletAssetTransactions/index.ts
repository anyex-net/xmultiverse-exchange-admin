...
// prettier-ignore
import { listWallTransactions, getWallTransactions } from "@/api/asset/walletAssetTransactions";
...
export default () => {
  ...
  const getList = () => { for (let key in queryParams.value) {
    ...
    loading.value = true;
    // prettier-ignore
    listWallTransactions(queryParams.value).then((response) => {
  ...
  const handleUpdate = (row: any) => {
    ...
    getWallTransactions(configId).then((response: any) => {
