...
export const listDatas = async (query: any) => {
  return await request({
    url: "/api/rwa/rwaInstSpvProduct/data",
    method: "post",
    data: query,
  });
};
...
export const getDatas = async (id: number) => {
  return await request({
    url: "/api/rwa/rwaInstSpvProduct/findBy?id=" + id,
    method: "get",
  });
};
...
export const addDatas = async (param: any) => {
  return await request({
    url: "/api/rwa/rwaInstSpvProduct/save",
    method: "post",
    data: param,
  });
};
...
export const delDatas = async (data: any) => {
  return await request({
    url: "/api/rwa/rwaInstSpvProduct/del",
    method: "post",
    data: data,
  });
};
...
export const allDatas = async (query: any) => {
  return await request({
    url: "/api/rwa/rwaInstSpvProduct/all",
    method: "post",
    data: query,
  });
};
...
export const checkDatas = async (data: any) => {
  return await request({
    url: "/api/rwa/rwaInstSpvProduct/check",
    method: "post",
    data: data,
  });
};
