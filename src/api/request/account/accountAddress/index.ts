...
// prettier-ignore
import { listAddressArr, getAddressArr } from "@/api/account/accountAddress";
...
export default () => {
  ...
  const getList = () => { for (let key in queryParams.value) {
    ...
    loading.value = true;
    // prettier-ignore
    listAddressArr(queryParams.value).then((response) => {
  ...
  const handleUpdate = (row: any) => {
    ...
    getAddressArr(configId).then((response: any) => {
