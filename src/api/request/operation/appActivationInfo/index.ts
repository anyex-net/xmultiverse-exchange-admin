...
// prettier-ignore
import { listActArr,getActArr,delActArr} from "@/api/operation/appActivationInfo";
...
export default () => {
  ...
  const getList = () => {
    ...
    loading.value = true;
    // prettier-ignore
    listActArr(queryParams.value).then((response) => {
  ...
  const handleUpdate = (row: any) => {
    ...
    getActArr(configId).then((response: any) => {
