...
// prettier-ignore
import { listDwArr,getDwArr,delDwArr} from "@/api/operation/appDownloadInfo";
...
export default () => {
  ...
  const getList = () => {
    ...
    loading.value = true;
    // prettier-ignore
    listDwArr(queryParams.value).then((response) => {
  ...
  const handleUpdate = (row: any) => {
    ...
    getDwArr(configId).then((response: any) => {
