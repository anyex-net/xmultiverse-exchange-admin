...
export const listDatas = async (query: any) => {
    return await request({
        url: "/api/user/userHoldAmountRewardConfig/data",
        method: "post",
        data: query,
    });
};
...
export const getDatas = async (id: number) => {
    return await request({
        url: "/api/user/userHoldAmountRewardConfig/findBy?id=" + id,
        method: "get",
    });
};
...
export const addDatas = async (param: any) => {
    return await request({
        url: "/api/user/userHoldAmountRewardConfig/save",
        method: "post",
        data: param,
    });
};
...
export const delDatas = async (data: any) => {
    return await request({
        url: "/api/user/userHoldAmountRewardConfig/del",
        method: "post",
        data: data,
    });
};
...
export const checkDatas = async (data: any) => {
    return await request({
        url: "/api/user/userHoldAmountRewardConfig/check",
        method: "post",
        data: data,
    });
};
