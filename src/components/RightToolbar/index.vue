    ...
    <div class="top-right-btn">
        <el-row>
            <el-tooltip class="item" effect="dark" :content="showSearch ? '隐藏搜索' : '显示搜索'" placement="top">
                <el-button v-if="show" type="primary" size="small" circle icon="search" @click="toggleSearch()" />
            </el-tooltip>
...
import { ref } from 'vue'
const value = ref<[]>([]);//显隐数据
const title = ref<string>("显示/隐藏");//弹出层标题
const open = ref<boolean>(false);//是否显示弹出层
...
const emit = defineEmits<{
    ...
    (event: 'update:showSearch', showSearch: boolean): void
}>()
//  搜索
const toggleSearch = () => {
