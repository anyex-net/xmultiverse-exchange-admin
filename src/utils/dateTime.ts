 ...
 * @returns
 */
export const dateTimeSub = (dataTime: any) => {
    if (!dataTime) {
        return "";
    }
...
export const selectDictLabels = (
    ...
    var temp:intertype = value.split(currentSeparator);
...
export const handleTree = (data: any, id: any, parentId:any, children: any) => {
    ...
    var childrenListMap:intertype= {};
    var nodeIds:intertype = {};
    var tree = [];
