                ...
                >
                    <template #default="scope">
                        <el-link
                            ...
                            v-hasPermi="['rwa:rwaInstSpvProductRealizedIncome:data']"
...
<script lang="ts" name="rwaInstSpvProductRealizedIncome" setup>
import datas from "@/hooks/rwa/rwaInstSpvProductRealizedIncome";
import {
    formSearchs,
    titles,
    formOptions,
    formtitles,
    rules,
} from "@/data/rwa/rwaInstSpvProductRealizedIncome";
