...
<!--        <el-table-column label="主键" prop="id" min-width="150px" />-->
        ...
        <el-table-column label="创建时间" prop="createTime" min-width="150px" />
          <el-table-column label="updateBy" prop="更新人" min-width="150px" />
        ...
        >
          <template #default="scope">
            <el-link
              ...
              v-hasPermi="['rwa:rwaInstSpvProductAsset:data']"
            ...
            >
              <div v-if="scope.row.state === 0">
                  ...
                  <el-link
                      ...
                      v-hasPermi="['rwa:rwaInstSpvProductAsset:operator']"
                  >
...
<script lang="ts" name="rwaInstSpvProductAsset" setup>
import datas from "@/hooks/rwa/rwaInstSpvProductAsset";
import {
  formSearchs,
  titles,
  formOptions,
  formtitles,
  rules,
} from "@/data/rwa/rwaInstSpvProductAsset";
