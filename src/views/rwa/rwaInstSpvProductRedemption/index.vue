        ...
        >
          <template #default="scope">
            <el-link
              ...
              v-hasPermi="['rwa:rwaInstSpvProductRedemption:data']"
...
<script lang="ts" name="rwaInstSpvProductRedemption" setup>
import datas from "@/hooks/rwa/rwaInstSpvProductRedemption";
import {
  formSearchs,
  titles,
  formOptions,
  formtitles,
  rules,
} from "@/data/rwa/rwaInstSpvProductRedemption";
