...
<script lang="ts" name="rwaInstSpvProductDividendSnapshot" setup>
import datas from "@/hooks/rwa/rwaInstSpvProductDividendSnapshot";
import {
  formSearchs,
  titles,
  formOptions,
  formtitles,
  rules,
} from "@/data/rwa/rwaInstSpvProductDividendSnapshot";
