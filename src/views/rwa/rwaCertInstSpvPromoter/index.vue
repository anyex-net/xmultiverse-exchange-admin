...
<!--        <el-table-column label="主键" prop="id" min-width="150px" />-->
          ...
          >
              ...
              <template #default="scope">
                  <div v-if="['promoterCoRegistrImg','agentPassportImg1','agentPassportImg2','agentPassportImg3','agentAuthorizationFile'].includes(i.name)">
        ...
        >
          <template #default="scope">
            <el-link
              ...
              v-hasPermi="['rwa:rwaCertInstSpvPromoter:data']"
            ...
            >
              <div v-if="scope.row.state === '0'">
                  ...
                  <el-link
                      ...
                      v-hasPermi="['rwa:rwaCertInstSpvPromoter:check']"
                  >
          ...
          <el-row v-for="(group, groupIndex) in formtitles" :key="groupIndex">
              <el-col :span="12" v-for="item in group" :key="item.name">
                  <el-form-item :label="item.title" :prop="item.name">
                      ...
                      <div v-else-if="['promoterCoRegistrImg','agentPassportImg1','agentPassportImg2','agentPassportImg3','agentAuthorizationFile'].includes(item.name)">
                          <el-image
...
<script lang="ts" name="rwaCertInstSpvPromoter" setup>
import datas from "@/hooks/rwa/rwaCertInstSpvPromoter";
import {
  formSearchs,
  titles,
  formOptions,
  formtitles,
  rules,
} from "@/data/rwa/rwaCertInstSpvPromoter";
