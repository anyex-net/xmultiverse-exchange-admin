                ...
                >
                    <template #default="scope">
                        <el-link
                            ...
                            v-hasPermi="['rwa:rwaInstSpvProductDividend:data']"
...
<script lang="ts" name="rwaInstSpvProductDividend" setup>
import datas from "@/hooks/rwa/rwaInstSpvProductDividend";
import {
    formSearchs,
    titles,
    formOptions,
    formtitles,
    rules,
} from "@/data/rwa/rwaInstSpvProductDividend";
