<template>
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="收藏用户ID" prop="favoriteAccountId">
        <el-input
          v-model="queryParams.favoriteAccountId"
          placeholder="请输入"
          clearable
          style="width: 240px"
          @keyup.enter.native="handleQuery()"
    ...
    <el-row :gutter="10" class="mb8">
      <!-- <el-col :span="1.5">
        <el-button
          ...
          size="small"
          @click="handleAdd"
          v-hasPermi="['news:newsFavorite:operator']"
          >新增
        </el-button>
      </el-col>
    ...
    <div class="self-table">
      ...
      >
        ...
        <el-table-column label="资讯ID" prop="newsId" />
        <el-table-column label="收藏用户ID" prop="favoriteAccountId" />
        <el-table-column label="位置经度" prop="lng" />
        <el-table-column label="位置纬度" prop="lat" />
    ...
    >
      <el-form size="small" ref="formRef" :model="form">
        ...
        <el-form-item label="位置纬度" prop="lat" style="font-weight: 600">
