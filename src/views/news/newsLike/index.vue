<template>
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="点赞用户ID" prop="likeAccountId">
        <el-input
          v-model="queryParams.likeAccountId"
          placeholder="请输入"
          clearable
          style="width: 240px"
          @keyup.enter.native="handleQuery()"
    ...
    <el-row :gutter="10" class="mb8">
      <!-- <el-col :span="1.5">
        <el-button
          ...
          size="small"
          @click="handleAdd"
          v-hasPermi="['news:newsLike:operator']"
          >新增
        </el-button>
      </el-col>
    ...
    <div class="self-table">
      ...
      >
        ...
        <el-table-column label="点赞用户ID" prop="likeAccountId" />
