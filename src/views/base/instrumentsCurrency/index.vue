    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="small"
          @click="handleAdd"
          v-hasPermi="['base:instrumentsCurrency:operator']"
          >新增</el-button
        >
      </el-col>
        ...
        >
          <template #default="scope">
              <el-link
                  ...
                  v-hasPermi="['base:instrumentsCurrency:data']"
          ...
          <el-col :span="12" v-for="i2 in i" :key="i2.name">
            <el-form-item :label="i2.title" :prop="i2.name">
              ...
              >
                ...
                />
                <el-upload
                    v-else-if="i2.type === 'uploading'"
                    :ref="(el:any) => setUploadRef(el, i2.name)"
                    class="upload-demo"
                    ...
                    @change="(file:any) => iconChange(file, i2.name)"
                >
                    <div v-if="form[i2.name] == ''" class="img_upload">
                        <el-icon class="icon"><Plus /></el-icon>
                    </div>
                    <div v-else class="img_upload">
                        <img class="img1" :src="uploadUrl + form[i2.name]" alt="" />
                    </div>
                </el-upload>
              <el-input
                v-else
...
<script lang="ts" name="instrumentsCurrency" setup>
import datas from "@/hooks/base/instrumentsCurrency";
...
import {
  ...
  formtitles,
  rules,
} from "@/data/base/instrumentsCurrency";
