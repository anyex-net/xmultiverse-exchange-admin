...
<!--          size="small"-->
<!--          @click="handleAdd"-->
<!--          v-hasPermi="['base:userInstrumentsFavorite:operator']"-->
<!--          >新增</el-button-->
<!--        >-->
<!--      </el-col>-->
        ...
        >
          <template #default="scope">
              <el-link
                  ...
                  v-hasPermi="['base:userInstrumentsFavorite:data']"
...
<script lang="ts" name="instruments" setup>
import datas from "@/hooks/base/userInstrumentsFavorite";
...
import {
  ...
  formtitles,
  rules,
} from "@/data/base/userInstrumentsFavorite";
...
const {
  ...
  getList, resetQuery, cancel,cleanSelect,
  handleQuery, handleAdd, handleSelectionChange,handleShowDetail, isShowBtn,
} = datas();
</script>
