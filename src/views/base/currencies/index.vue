    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="small"
          @click="handleAdd"
          v-hasPermi="['base:currencies:operator']"
          >新增</el-button
        >
      </el-col>
        ...
        >
          <template #default="scope">
              <el-link
                  ...
                  v-hasPermi="['base:currencies:data']"
...
<script lang="ts" name="currencies" setup>
import currencies from "@/hooks/base/currencies";
