        ...
        >
          <template #default="scope">
              <el-link
                  ...
                  v-hasPermi="['base:userInstTradeFee:data']"
...
<script lang="ts" name="userInstTradeFee" setup>
import datas from "@/hooks/base/userInstTradeFee";
...
import {
  ...
  formtitles,
  rules,
} from "@/data/base/userInstTradeFee";
