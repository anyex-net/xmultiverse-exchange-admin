  ...
  <div class="app-container">
    ...
    <div class="self-table">
      ...
      >
        ...
        <el-table-column label="变动发生额" prop="balance" min-width="120px">
          <template #default="scope">
            <span
              >{{ scope.row.direction }}{{ scope.row.balance.toFixed(2) }}</span
            >
          </template>
        </el-table-column>
    ...
    >
      <el-form size="small" ref="formRef" :model="form" :rules="rules">
        ...
        >
          <span class="mRbox"
            >{{ form.direction }}{{ Number(form.balance).toFixed(2) }}</span
          >
        </el-form-item>
...
import walletAssetFlows from "@/hooks/asset/walletAssetFlows";
