...
<!--            <el-form-item label="币种" prop="currency">
        ...
        <div class="self-table">
            <el-table size="small" stripe v-loading="loading" ref="pageTableRef" :data="configList"
                ...
                <el-table-column label="账户ID" fixed prop="accountId" min-width="140px" />
                ...
                <el-table-column label="操作"  fixed="right" min-width="90px" class-name="small-padding fixed-width">
                    ...
                    <template #default="scope">
                        <el-link class="table_link_btn" :underline="false" type="primary"
                            @click="handleUpdate(scope.row)" v-hasPermi="['asset:walletAsset:operator']"><span
      ...
      <el-dialog :title="title" v-model="openAdjust" width="500px" append-to-body @close="cleanSelect()">
        <el-form size="small" ref="formAdjustRef" :model="formAdjust" :rules="rulesAdjust">
          ...
          <el-form-item label="调整方向" prop="direction"  style="font-weight: 600;" >
            <el-select v-model="formAdjust.direction" placeholder="请选择" style="width:300px;" >
...
import walletAsset from "@/api/request/asset/walletAsset/index";
