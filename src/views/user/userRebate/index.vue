...
import datas from "@/hooks/user/userRebate";
...
const {
  ...
  title,loading, open, showSearch, total, dataList,
  getList, resetQuery, cancel, cleanSelect,
  handleQuery, handleSelectionChange,handleShowDetail, isShowBtn,
} = datas();
</script>
