    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="small"
          @click="handleAdd"
          v-hasPermi="['user:userHoldAmountRewardConfig:operator']"
          >新增</el-button
        >
      </el-col>
        ...
        >
          <template #default="scope">
              <el-link
                  ...
                  v-hasPermi="['user:userHoldAmountRewardConfig:data']"
...
<!--                    &lt;!&ndash; 使用 el-input 以只读形式展示状态值 &ndash;&gt;-->
<!--                    <el-input-->
...
import datas from "@/hooks/user/userHoldAmountRewardConfig";
...
import {
  ...
  formtitles,
  rules,
} from "@/data/user/userHoldAmountRewardConfig";
...
const {
  ...
  handleQuery, handleAdd, handleSelectionChange,handleStatusChange, handleDelete, handleShowDetail, isShowBtn,handleUpdate
} = datas();
</script>
