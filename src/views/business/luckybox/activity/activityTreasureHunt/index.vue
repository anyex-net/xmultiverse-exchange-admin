    ...
    <div class="app-container">
        ...
        >
            ...
            <el-form-item label="产品spu" prop="spuId">
                <el-select v-model="queryParams.spuId" @change="getSelects" placeholder="请选择"
                           style="width: 240px">
                    <el-option v-for="item in spuLists" :key="item.id" :label="item.title" :value="item.id"></el-option>
                </el-select>
            </el-form-item>
            <el-form-item label="商品sku" prop="skuId">
                <el-select v-model="queryParams.skuId" clearable @change="handleQuery()" placeholder="请选择"
                           style="width: 240px">
                    <el-option v-for="item in skuList" :key="item.id" :label="item.title" :value="item.id"></el-option>
                </el-select>
            </el-form-item>
        ...
        >
            ...
            >
                ...
                <el-form-item label="产品spu" prop="spuId">
                    <el-select v-model="form.spuId" @change="getSelect" placeholder="请选择" style="width: 100%">
                        <el-option v-for="item in spuLists" :key="item.id" :label="item.title"
                                   :value="item.id"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="商品sku" prop="skuId">
                    <el-select v-model="form.skuId" placeholder="请选择" style="width: 100%">
                        <el-option v-for="item in skuList" :key="item.id" :label="item.title"
                                   :value="item.id"></el-option>
                    </el-select>
                </el-form-item>
...
import ActivityTreasureHunt from "@/api/request/business/luckybox/activity/activityTreasureHunt";
