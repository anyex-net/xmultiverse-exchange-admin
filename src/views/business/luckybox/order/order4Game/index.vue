  ...
  <div class="app-container">
    ...
    >
      <el-form size="small" ref="formRef" :model="form" :rules="rules">
        ...
        >
          <span class="mRbox">{{
            Number(form.gameExpendBalance).toFixed(2)
          }}</span>
        </el-form-item>
        <el-form-item
          label="奖励金额"
        ...
        >
          <span class="mRbox">{{
            Number(form.gameRewardBalance).toFixed(2)
          }}</span>
        </el-form-item>
        <el-form-item
          label="奖品名称"
...
import order4Game from "@/hooks/business/luckybox/order/order4Game";
