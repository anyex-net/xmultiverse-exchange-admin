  ...
  <div class="app-container">
    ...
    <div class="self-table">
      ...
      >
        ...
        <el-table-column label="标题" prop="title" min-width="120px" />
        <el-table-column label="副标题" prop="subTitle" min-width="120px" />
        <el-table-column label="是否上架" prop="saleable" min-width="100px">
          <template #default="scope">
            <span v-if="scope.row.saleable">是</span>
            <span v-else>否</span>
          </template>
        </el-table-column>
        <el-table-column label="是否有效" prop="valid" min-width="100px">
          <template #default="scope">
...
import GoodsSpu from "@/hooks/business/luckybox/goods/goodsSpu";
