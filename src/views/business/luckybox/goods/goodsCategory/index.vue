            ...
            >
                <el-form-item label="上级分类" prop="parentId">
                    <el-tree-select v-model="form.parentId" :data="treeOptions"
                                    ...
                                    placeholder="选择上级分类" check-strictly filterable :render-after-expand="false"
                                    style="width: 100%;" />
                </el-form-item>
                <el-form-item label="分类名称" prop="name">
                    <el-input
        ...
        >
            ...
            >
                ...
                <el-form-item label="商品品牌" prop="goodsBrandIds">
                    <el-select v-model="form1.goodsBrandIds" multiple placeholder="请选择" style="width: 100%" >
...
import GoodsCategory from "@/api/request/business/luckybox/goods/goodsCategory";
