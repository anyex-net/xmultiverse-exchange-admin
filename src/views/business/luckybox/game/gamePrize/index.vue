  ...
  <div class="app-container">
    ...
    <div class="self-table">
      ...
      >
        ...
        <el-table-column label="游戏ID" prop="gameId" min-width="150px" fixed />
        <el-table-column label="奖品名称" prop="prizeName" min-width="120px" />
        <el-table-column label="成本" prop="cost" min-width="100px" />
        <el-table-column label="商品价格" prop="price" min-width="100px" />
        <el-table-column
          label="百份中奖数量"
        ...
        <el-table-column
          ...
          min-width="100px"
        />
        <el-table-column label="奖品图片" prop="prizeImgUrl" min-width="100px">
    ...
    >
      ...
      >
        ...
        <el-form-item label="奖品名称" prop="prizeName">
          <el-input v-model="form.prizeName" placeholder="请输入" />
        </el-form-item>
        <el-form-item label="成本" prop="cost">
          <el-input type="number" v-model="form.cost" placeholder="请输入" />
        </el-form-item>
...
import GamePrize from "@/hooks/business/luckybox/game/gamePrize";
