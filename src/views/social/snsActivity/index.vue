    ...
    <div class="app-container">
        <el-form size="small" :model="queryParams" ref="queryFormRef" :inline="true" v-show="showSearch"
            ...
            <el-form-item label="标题" prop="title">
                <el-input style="width: 200px" v-model="queryParams.title"
                          placeholder="请输入标题"
                          clearable
            ...
            <el-form-item label="活动标签" prop="activitytag">
                <el-input style="width: 200px" v-model="queryParams.activitytag"
                          placeholder="请输入活动标签"
                          clearable
                          @keyup.enter="handleQuery"
                          @change="handleQuery()"
            ...
            <el-form-item label="状态" prop="status">
                <el-select style="width: 200px" @change="handleQuery" v-model="queryParams.status" placeholder="请选择状态" clearable>
        ...
        <div class="self-table">
            <el-table size="small" v-loading="loading" :data="configList" @selection-change="handleSelectionChange">
                ...
                <el-table-column label="标题" fixed align="center" prop="title" min-width="130px"  />
                ...
                <el-table-column label="活动标签" align="center" prop="activityTag" min-width="130px" />
                <el-table-column label="链接地址" align="center" prop="openUrl" min-width="150px" />
                ...
                <el-table-column label="操作" fixed="right" align="center" class-name="small-padding fixed-width" min-width="130px">
                    <template #default="scope">
                        <el-link class="table_link_btn" :underline="false" type="primary"
                                 @click="handleDetails(scope.row)" v-hasPermi="['social:snsActivity:operator']"><span
                            class="table_link_text">详情</span></el-link>
                        <el-link class="table_link_btn" :underline="false" type="primary"
                                 @click="handleUpdate(scope.row)" v-hasPermi="['social:snsActivity:operator']"><span
                            class="table_link_text">修改</span></el-link>
                        <el-link class="table_link_btn" :underline="false" type="primary"
                                 @click="handleDelete(scope.row)" v-hasPermi="['social:snsActivity:operator']"><span
                            class="table_link_text">删除</span>
                        </el-link>
                    </template>
                </el-table-column>
            </el-table>
                ...
                <el-row>
                    ...
                    <el-col :span="24">
                        <el-form-item label="内容" prop="content">
                            <el-input autosize type="textarea" v-model="form.content" placeholder="请输入内容" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
                        <el-form-item label="主图" prop="imgUrl">
                            ...
                            <el-upload ref="upload" class="upload-demo" accept=".png, .jpg,.jpeg,.gif,.webp,.jfif"
                                       :auto-upload="false" :on-change="doChange" :action="uploadUrl"
                                       :data="uploadParams"
                    ...
                    <el-col :span="24">
                        <el-form-item label="备注" prop="remark">
                            <el-input autosize type="textarea" v-model="form.remark" placeholder="请输入备注" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
                        <el-form-item label="状态" prop="status">
        ...
        <el-dialog :title="title1" v-model="open1" width="500px" append-to-body>
            <el-form ref="formRef" size="small" :model="form" >
                <el-row>
                    ...
                    <el-col :span="24">
                        <el-form-item label="活动标签" prop="activityTag"  style="font-weight: 600;">
                            <span class="mRbox">{{ form.activityTag }}</span>
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
                        <el-form-item label="链接地址" prop="openUrl"  style="font-weight: 600;">
                    ...
                    <el-col :span="24">
                        <el-form-item label="创建时间" prop="status"  style="font-weight: 600;">
                            <span class="mRbox" >{{parseTime(form.createTime)}}</span>
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
                        <el-form-item label="更新时间" prop="status"  style="font-weight: 600;">
...
import SnsActivity from "@/api/request/social/snsActivity";
