  ...
  <div class="app-container">
    ...
    >
      <el-form-item label="点赞用户ID" prop="likeUserId">
        <el-input
          v-model="queryParams.likeUserId"
          placeholder="请输入"
          clearable
          style="width: 240px"
    ...
    <el-row :gutter="10" class="mb8">
      <!-- <el-col :span="1.5">
        <el-button
          ...
          size="small"
          @click="handleAdd"
          v-hasPermi="['social:snsPostCommentLike:operator']"
          >新增
        </el-button>
      </el-col> -->
    ...
    <div class="self-table">
      ...
      >
        ...
        <el-table-column label="点赞用户ID" prop="likeUserId" />
        <el-table-column label="帖子评论ID" prop="postCommentId" />
        <el-table-column label="帖子ID" prop="postId" />
        <el-table-column label="经度" prop="lat" />
        <el-table-column label="纬度" prop="lng" />
    ...
    >
      <el-form size="small" ref="formRef" :model="form" :rules="rules">
        ...
        <el-form-item
          ...
          style="font-weight: 600"
        >
          <span class="mRbox">{{ form.postCommentId }}</span>
        </el-form-item>
        <el-form-item label="帖子ID" prop="postId" style="font-weight: 600">
          <span class="mRbox">{{ form.postId }}</span>
        </el-form-item>
        <el-form-item label="经度" prop="lat" style="font-weight: 600">
          <span class="mRbox">{{ form.lat }}</span>
        </el-form-item>
        <el-form-item label="纬度" prop="lng" style="font-weight: 600">
