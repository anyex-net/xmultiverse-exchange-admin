<template>
    <div class="app-container">
        <el-form size="small" :model="queryParams" ref="queryFormRef" :inline="true" v-show="showSearch"
            ...
            <el-form-item label="关注者用户Id" prop="followerUserId">
                <el-input v-model="queryParams.followerUserId" placeholder="请输入" clearable style="width: 240px" @keyup.enter.native="handleQuery()" @change="handleQuery()" />
            </el-form-item>
        ...
        <div class="self-table">
            <el-table size="small" stripe v-loading="loading" ref="pageTableRef" :data="configList"
                ...
                <el-table-column label="关注者用户Id" prop="followerUserId" min-width="100px" />
        ...
        <el-dialog :title="title" v-model="open" width="500px" append-to-body @close="cleanSelect()">
            <el-form size="small" ref="formRef" :model="form" :rules="rules">
                ...
                <el-form-item label="关注者用户Id" prop="followerUserId" style="font-weight: 600;">
                    <span class="mRbox">{{ form.followerUserId }}</span>
                </el-form-item>
...
<script lang="ts" name="snsFans" setup>
import snsFans from "@/api/request/social/snsFans/index";
