<template>
    <div class="app-container">
        <el-form size="small" :model="queryParams" ref="queryFormRef" :inline="true" v-show="showSearch"
            ...
            <el-form-item label="分享用户Id" prop="shareUserId">
                <el-input v-model="queryParams.shareUserId" placeholder="请输入" clearable style="width: 240px" @keyup.enter.native="handleQuery()" @change="handleQuery()" />
            </el-form-item>
        ...
        <el-row :gutter="10" class="mb8">
            <el-col :span="1.5">
                <el-button type="danger" plain  size="small" :disabled="multiple" @click="handleDelete" v-hasPermi="['social:snsPostShare:operator']">删除</el-button>
            </el-col>
        ...
        <div class="self-table">
            <el-table size="small" stripe v-loading="loading" ref="pageTableRef" :data="configList"
                ...
                <el-table-column label="分享用户Id" prop="shareUserId" min-width="100px" />
                ...
                <el-table-column label="操作" fixed="right" min-width="140" class-name="small-padding fixed-width">
                    <template #default="scope">
                        ...
                        <el-link
                            ...
                            v-hasPermi="['social:snsPostShare:operator']"
        ...
        <el-dialog :title="title" v-model="open" width="500px" append-to-body @close="cleanSelect()">
            <el-form size="small" ref="formRef" :model="form" :rules="rules">
                ...
                <el-form-item label="分享用户Id" prop="shareUserId" style="font-weight: 600;">
                    <span class="mRbox">{{ form.shareUserId }}</span>
                </el-form-item>
...
<script lang="ts" name="snsPostShare" setup>
import snsPostShare from "@/api/request/social/snsPostShare/index";
