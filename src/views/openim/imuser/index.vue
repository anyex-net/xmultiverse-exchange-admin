<template>
  <div class="app-container">
    <el-form
      ...
      label-width="70px"
    >
      <el-form-item label="用户昵称" prop="accountName">
        <el-input
    ...
    <div class="self-table">
      ...
      >
        ...
        <el-table-column label="状态" prop="valid">
          <template #default="scope">
        ...
        >
          <template #default="scope">
            <el-link
              ...
              :underline="false"
              type="primary"
              @click="logoutIt(scope.row)"
              v-hasPermi="['openim:imuser:operator']"
              ><span class="table_link_text">强制下线</span></el-link
            >
            <el-link
              class="table_link_btn"
              :underline="false"
              type="primary"
              @click="findUserFriend(scope.row)"
              v-hasPermi="['openim:imuser:operator']"
              ><span class="table_link_text">关系链</span></el-link
            >
            <!-- <el-link
              class="table_link_btn"
              :underline="false"
    ...
    >
      <div class="self-table">
        <el-table
          ...
          v-loading="loading"
          ref="pageTableRef"
          :data="showListFriends"
        >
          <!-- <el-table-column label="ID" fixed prop="ownerUserID" /> -->
          ...
          <el-table-column label="用户昵称" prop="friendUser.nickname" />
          <el-table-column label="用户ID" prop="friendUser.userID" />
          <el-table-column
            label="操作"
            fixed="right"
            class-name="small-padding fixed-width"
      ...
      <pagination
        v-show="total2 > 0"
        :total="total2"
        v-model:page="queryId.current"
        v-model:limit="queryId.size"
        @pagination="getfriendList()"
      />
    </el-dialog>
  </div>
</template>
