  ...
  <div class="app-container">
          ...
          <template #default="scope">
            ...
            >
              <span
                ...
                v-if="scope.row.groupInfo.status == '0'"
                style="color: #ff0000"
                >全体禁言</span
              >
              <span
                class="table_link_text"
                v-if="scope.row.groupInfo.status == '3'"
                >取消禁言</span
              >
            </el-link>
            <el-link
    ...
    >
      ...
      >
          ...
          >
            ...
            >
              ...
              <div v-else class="img_upload">
                <img
                  class="img1"
                  :src="uploadUrl + form.groupInfo.faceURL"
                  alt=""
                />
              </div>
            </el-upload>
        ...
        <el-form-item label="群验证" prop="groupInfo.needVerification">
          <el-select
            style="width: 100%"
            v-model="form.groupInfo.needVerification"
            placeholder="请选择"
          >
            <el-option
        ...
        <el-form-item label="添加好友" prop="groupInfo.applyMemberFriend">
          <el-select
            style="width: 100%"
            v-model="form.groupInfo.applyMemberFriend"
            placeholder="请选择"
          >
            <el-option
        ...
        <el-form-item label="查看资料" prop="groupInfo.lookMemberInfo">
          <el-select
            style="width: 100%"
            v-model="form.groupInfo.lookMemberInfo"
            placeholder="请选择"
          >
            <el-option
      ...
      >
        <el-row>
          ...
          >
            ...
            >
              <div
                v-if="form1.groupInfoForSet.faceURL == ''"
                class="img_upload"
              >
                <el-icon class="icon">
                  <Plus />
              ...
              <div v-else class="img_upload">
                <img
                  class="img1"
                  :src="uploadUrl + form1.groupInfoForSet.faceURL"
                  alt=""
                />
              </div>
            </el-upload>
        ...
        <el-form-item label="群组名称" prop="groupInfoForSet.groupName">
          <el-input
            v-model="form1.groupInfoForSet.groupName"
            placeholder="请输入"
          />
        </el-form-item>
        <el-form-item label="群组ID" prop="groupInfoForSet.groupID">
          <el-input
            readonly
            v-model="form1.groupInfoForSet.groupID"
            placeholder="请输入"
          />
        </el-form-item>
        <el-form-item label="群验证" prop="groupInfoForSet.needVerification">
          <el-select
            style="width: 100%"
            v-model="form1.groupInfoForSet.needVerification"
            placeholder="请选择"
          >
            <el-option
              v-for="item in needList"
        ...
        <el-form-item label="添加好友" prop="groupInfoForSet.applyMemberFriend">
          <el-select
            style="width: 100%"
            v-model="form1.groupInfoForSet.applyMemberFriend"
            placeholder="请选择"
          >
            <el-option
              v-for="item in applyList"
        ...
        <el-form-item label="查看资料" prop="groupInfoForSet.lookMemberInfo">
          <el-select
            style="width: 100%"
            v-model="form1.groupInfoForSet.lookMemberInfo"
            placeholder="请选择"
          >
            <el-option
              v-for="item in lookList"
    ...
    >
      <div class="userS">
        ...
        <div class="userS_left">
          <div class="userS_left_item">
            已选择成员:{{ secondaryTableData.length }}
          </div>
          <el-table
            size="small"
            :row-key="getRowKeys"
    ...
    >
      <div class="userS">
        <div class="userS_left">
          ...
          >
            <el-table-column
              :selectable="isCheckboxDisabled2"
              :reserve-selection="true"
              type="selection"
              width="55"
              align="center"
...
import groupList from "@/hooks/openim/group";
