...
<!--            </el-form-item>-->
            ...
            >
                ...
                <el-table-column label="用户头像" prop="faceURL">
                    <template #default="scope">
                        <img  v-if="scope.row.faceURL=='headUrl' || scope.row.faceURL==''"
                              src="../../../../assets/images/touxiang.png" style="width: 30px; height: 30px" />
                        <el-image
                            v-else
        ...
        <el-drawer
            ...
            size="400px"
        >
            <el-radio-group v-model="form.roleLevel" style="display: flex;flex-direction: column;align-items: flex-start">
           ...
           <div style="display: flex;justify-content: flex-end;margin-top: 30px">
               <el-button v-if="form.roleLevel!=roleLevel" size="small" type="primary" @click="submitForm">确 定</el-button>
           </div>
        </el-drawer>
        <!--   禁言-->
        <el-drawer
            ...
            size="400px"
        >
            <el-radio-group v-model="form1.mutedSeconds" style="display: flex;flex-direction: column;align-items: flex-start">
                    ...
                    >
                        ...
                        >
                            <template #default="scope">
                                ...
                                <img style="width: 30px; height: 30px;border-radius: 10px" v-else src="../../../../assets/images/touxiang.png"  /></template>
                        </el-table-column>
                        <el-table-column
                            label="用户昵称"
                            prop="accountName"
                        ...
                        >
                            <template #default="scope">
                                <el-image
                                    ...
                                    style="width: 30px; height: 30px;border-radius: 10px"
                                    :src="scope.row.headUrl"></el-image>
                                <img style="width: 30px; height: 30px;border-radius: 10px" v-else src="../../../../assets/images/touxiang.png"  />
...
import groupMember from "@/api/request/openim/group/groupMember";
