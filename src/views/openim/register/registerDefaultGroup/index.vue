            ...
            >
                ...
                >
                    <template #default="scope">
                        ...
                        <img v-else src="../../../../assets/images/touxiang.png" style="width: 40px; height: 40px;border-radius: 10px"  /></template>
                </el-table-column>
                <el-table-column
                    label="群组ID"
                    prop="groupId"
...
import registerDefaultGroup from "@/api/request/openim/register/registerDefaultGroup";
