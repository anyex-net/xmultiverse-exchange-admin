<template>
    <div class="app-container">
        <el-form
            ...
            label-width="70px"
        >
            <el-form-item label="业务表名" prop="userId">
                <el-select
...
import balances from "@/hooks/spot/userDealHistory";

// prettier-ignore
const {
    loading, single, multiple, open, showSearch, total, dataList, title, queryParams, queryFormRef, form, formRef,
    getList, cancel, handleQuery, resetQuery, pageTableRef, cleanSelect, forms,tableNames
} = balances();
</script>
