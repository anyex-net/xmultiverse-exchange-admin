    ...
    <div class="app-container">
        <el-form size="small" :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch">
            <el-form-item label="角色名称" prop="roleName">
                <el-input v-model="queryParams.roleName" placeholder="请输入" clearable style="width: 240px"
        ...
        <el-row :gutter="10" class="mb8">
            <el-col :span="1.5">
                <el-button v-hasPermi="['system:resource:operator']" type="primary" plain size="small"
                           @click="handleAdd">新增
                </el-button>
            </el-col>
            <!--            <el-col :span="1.5">-->
            ...
            <el-col :span="1.5">
                <el-button type="danger" plain size="small" :disabled="multiple" @click="handleDelete"
                           v-hasPermi="['system:resource:operator']">删除
                </el-button>
            </el-col>
            <el-col :span="1.5">
                <el-button type="warning" plain size="small" @click="handleExport"
                           v-hasPermi="['system:resource:operator']">前端导出
                </el-button>
            </el-col>
            <el-col :span="1.5">
                <el-button type="warning" plain size="small" @click="handleExport1"
                           v-hasPermi="['system:resource:operator']">后端导出
                </el-button>
            </el-col>
            <el-col :span="1.5">
                <el-button type="warning" plain size="small" @click="handleExportPdf"
                           v-hasPermi="['system:resource:operator']">导出pdf
                </el-button>
            </el-col>
            <right-toolbar v-model:showSearch="showSearch" @queryTable="handleQuery()" />
        </el-row>
        <div class="self-table">
            <el-table id="my-table" size="small" stripe v-loading="loading" ref="pageTableRef" :data="roleList"
                ...
                <el-table-column label="操作" min-width="150" class-name="small-padding fixed-width">
                    <template #default="scope">
                        <el-link class="table_link_btn" :underline="false" type="primary"
                                 @click="handleUpdate(scope.row)" v-hasPermi="['system:resource:operator']"><span
                            class="table_link_text">修改</span></el-link>
                        <el-link class="table_link_btn" :underline="false" size="small" type="primary"
                                 @click="handleDelete(scope.row)" v-hasPermi="['system:resource:operator']"><span
                            class="table_link_text">删除</span></el-link>
                        <el-link class="table_link_btn" :underline="false" size="small" type="primary"
                                 @click="setJurisdiction(scope.row)" v-hasPermi="['system:resource:operator']"><span
                            class="table_link_text">权限分配</span></el-link>
                    </template>
                </el-table-column>
            </el-table>
        </div>
        ...
        <el-dialog  :title="title" v-model="open" width="800px" append-to-body @close="cleanSelect()">
            <el-button type="warning" plain size="small" @click="handleExportPdfForm"
                       v-hasPermi="['system:resource:operator']">导出pdf
            </el-button>
            <div ref="formPdf">
                <el-form id="myForm"  size="small" ref="formRef" :model="form" :rules="rules" label-width="100px">
                    <el-row>
                        <el-col :span="12">
                            <el-form-item label="角色名称" prop="roleName">
                                <el-input class="elinput" v-model="form.roleName" placeholder="请输入" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                    ...
                    <el-row>
                        <el-col :span="24">
                            <el-form-item label="角色描述" prop="roleDest">
                                <el-input type="textarea" v-model="form.roleDest" placeholder="请输入" />
                            </el-form-item>
                        </el-col>
                    </el-row>
                </el-form>
        ...
        <!--    分配权限-->
        <el-dialog title="分配权限" v-model="setJurisdictionShow" width="500px" append-to-body @close="cleanSelect()">
            <div style="height: 500px;overflow: auto">
                <el-tree style="width:100%;height:100%;" :data="setJurisdictionTableData"
                         :props="{children: 'children',label: 'resName'}" ref="setJurisdictionTree" node-key="id"
                         :default-expand-all="false" show-checkbox check-strictly
                         @check="setJurisdictionTableDataSelect"></el-tree>
            </div>
            <template #footer>
                <div class="dialog-footer">
