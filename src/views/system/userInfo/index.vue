    ...
    <div class="app-container">
        <el-form size="small" :model="queryParams" ref="queryRef"  :inline="true" v-show="showSearch">
            ...
            <el-form-item label="手机号码" prop="phone">
                <el-input v-model="queryParams.phone" placeholder="请输入手机号码" type="number" clearable style="width: 240px"
...
<!--            </el-col>-->
        ...
        <el-table size="small" stripe v-loading="loading" ref="pageTableRef" :data="userList"
        ...
        <el-dialog :title="title" v-model="open" width="700px" append-to-body @close="cleanSelect()">
            <el-form size="small" ref="formRef" :model="form" :rules="rules" label-width="100px">
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="用户名" prop="userName">
                    ...
                    <el-col :span="12">
                        <el-form-item label="性别" prop="gender">
                            <el-select v-model="form.gender" placeholder="请选择性别">
                                <el-option v-for="(dict, index) in sysUserSex" :key="dict.id" :label="dict.name"
                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="所属机构" prop="orgId">
                            <el-tree-select v-model="form.orgId" :data="deptOptions" :props="elTreeProps"
                                value-key="id" placeholder="请选择机构" check-strictly style="width: 200px"
                    ...
                    <el-col :span="12">
                        <el-form-item label="角色" prop="roleIds">
                            <el-select v-model="form.roleIds" placeholder="请选择角色"  multiple>
                                <el-option v-for="item in postOptions" :key="item.id" :label="item.roleName"  :value="item.id"></el-option>
                            </el-select>
                        </el-form-item>
                    </el-col>
                </el-row>
...
const { queryParams, showSearch, handleQuery, resetQuery, handleAdd, multiple, handleDelete, loading, userList, handleSelectionChange, handleUpdate, total, getList, title, open, form, rules, submitForm, cancel, elTreeProps, formRef, queryRef, pageTableRef, dateRange, dataTime, handleResetPwd, sysUserSex, userTypes, userParent, deptOptions, postOptions, single, handleStatusChange,cleanSelect} = User();
</script>
