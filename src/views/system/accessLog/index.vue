<template>
    <div class="app-container">
        ...
        <el-row :gutter="10" class="mb8">
            <el-col :span="1.5">
                <el-button type="danger" v-hasPermi="['system:accessLog:operator']" plain size="small"
            ...
            <el-table size="small" stripe v-loading="loading" ref="pageTableRef" :data="operateList"
                ...
                <el-table-column label="请求地址" prop="uri" min-width="150"  >
                    <template #default="scope">
                        <el-tooltip :disabled="isShowTooltip" :content="scope.row.uri" placement="top">
                            <!-- 单行省略样式、鼠标移入事件 -->
                            <div class="singe-line" @mouseover="onMouseOver($event.target)">{{ scope.row.uri }}</div>
                        </el-tooltip>
                    </template>
                </el-table-column>
                ...
                <el-table-column label="操作" fixed="right" align="center" width="80" class-name="small-padding fixed-width">
                    <template #default="scope">
                        <el-link class="table_link_btn" :underline="false" size="small" type="primary"
                            ...
                            class="table_link_text" v-hasPermi="['system:accessLog:operator']">删除</span></el-link>
...
import AccessLog from "@/api/request/system/accessLog";
