    ...
    <div class="app-container">
        ...
        <div class="self-table">
            <el-table size="small" v-loading="loading" :data="configList" @selection-change="handleSelectionChange">
                ...
                <el-table-column label="被邀请人账户ID" align="center" min-width="150px" prop="inviteActId" />
                ...
                <el-table-column label="被邀请人昵称" align="center" min-width="130px" prop="inviteActNick" />
                ...
                <el-table-column label="奖励金额" align="center" min-width="120px" prop="inviteAward" />
                <el-table-column label="顺序号" align="center" min-width="120px" prop="inviteActSeq" />
                <el-table-column label="状态" align="center" min-width="120px" prop="status" >
                    <template #default="scope">
                ...
                <el-table-column label="操作" align="center" fixed="right" min-width="150px" class-name="small-padding fixed-width">
                    <template #default="scope">
                        <el-link class="table_link_btn" :underline="false" type="primary"
                                 @click="handleUpdate(scope.row)" v-hasPermi="['account:accountInviteRewardsDetail:operator']"><span
        ...
        <el-dialog :title="title" v-model="open" width="500px" append-to-body @close="cleanSelect()">
            <el-form ref="formRef" size="small" :model="form" >
                <el-row>
                    ...
                    <el-col :span="24">
                        <el-form-item label="被邀请人账户ID" prop="inviteActId" style="font-weight: 600;">
                            <span class="mRbox">{{ form.inviteActId }}</span>
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
                        <el-form-item label="被邀请人头像" prop="inviteActHead" style="font-weight: 600;">
                    ...
                    <el-col :span="24">
                        <el-form-item label="被邀请人昵称" prop="inviteActNick" style="font-weight: 600;">
                    ...
                    <el-col :span="24">
                        <el-form-item label="奖励金额" prop="inviteAward" style="font-weight: 600;">
                            <span class="mRbox">{{ form.inviteAward }}</span>
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
                        <el-form-item label="顺序号" prop="inviteActSeq" style="font-weight: 600;">
                            <span class="mRbox">{{ form.inviteActSeq }}</span>
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
                        <el-form-item label="状态" prop="inviteActSeq" style="font-weight: 600;">
...
import AccountInviteRewardsDetail from "@/api/request/account/accountInviteRewardsDetail";
