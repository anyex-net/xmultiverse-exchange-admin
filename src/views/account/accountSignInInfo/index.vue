    ...
    <div class="app-container">
        ...
        <div class="self-table">
            <el-table size="small" v-loading="loading" :data="configList" @selection-change="handleSelectionChange">
                ...
                <el-table-column label="总积分" align="center" min-width="100px" prop="totalPoints" />
                <el-table-column label="剩余积分" align="center" min-width="100px" prop="remainingPoints" />
                <el-table-column label="积分等级" align="center" min-width="100px" prop="pointsLevel" />
                <el-table-column label="总签到次数" align="center" min-width="100px" prop="totalSigninTimes" />
                <el-table-column label="最高签到次数" align="center" min-width="100px" prop="maxsSigninTimes" />
                <el-table-column label="本轮累计签到次数" align="center" min-width="130px" prop="currentSigninTimes" />
                <el-table-column label="最后一次签到日期" align="center" min-width="150px" prop="lastSigninDate" >
                ...
                <el-table-column label="操作" align="center" fixed="right" min-width="150px" class-name="small-padding fixed-width">
                    <template #default="scope">
                        <el-link class="table_link_btn" :underline="false" type="primary"
                                 @click="handleUpdate(scope.row)" v-hasPermi="['account:accountSignInInfo:operator']"><span
        ...
        <el-dialog :title="title" v-model="open" width="500px" append-to-body @close="cleanSelect()">
            <el-form ref="formRef" size="small" :model="form" >
                <el-row>
                    ...
                    <el-col :span="24">
                        <el-form-item label="总积分" prop="totalPoints" style="font-weight: 600;">
                            <span class="mRbox">{{ form.totalPoints }}</span>
                        </el-form-item>
                    </el-col>

                    <el-col :span="24">
                        <el-form-item label="剩余积分" prop="remainingPoints" style="font-weight: 600;">
                            <span class="mRbox">{{ form.remainingPoints }}</span>
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
                        <el-form-item label="总签到次数" prop="pointsLevel" style="font-weight: 600;">
                            <span class="mRbox">{{ form.pointsLevel }}</span>
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
                        <el-form-item label="最高签到次数" prop="totalSigninTimes" style="font-weight: 600;">
                            <span class="mRbox">{{ form.totalSigninTimes }}</span>
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
                        <el-form-item label="本轮累计签到次数" prop="currentSigninTimes" style="font-weight: 600;">
                            <span class="mRbox">{{ form.currentSigninTimes }}</span>
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
                        <el-form-item label="最后一次签到日期" prop="lastSigninDate" style="font-weight: 600;">
...
import AccountSignInInfo from "@/api/request/account/accountSignInInfo";
