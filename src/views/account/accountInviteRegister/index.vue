  ...
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="邀请人UID" prop="inviteUnid">
        <el-input
          v-model="queryParams.inviteUnid"
          placeholder="请输入"
          clearable
          style="width: 240px"
          @keyup.enter.native="handleQuery()"
    ...
    总邀请人数<span v-html="Number(statisticsEntity.total).toFixed(0)"></span
    >&nbsp; &nbsp;今日邀请人数<span
      v-html="Number(statisticsEntity.curTotal).toFixed(0)"
    ></span>
...
import account from "@/hooks/account/accountInviteRegister";
