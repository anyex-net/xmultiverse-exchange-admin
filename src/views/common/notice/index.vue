    ...
    <div class="app-container">
        ...
        <div class="self-table">
            ...
            >
                ...
                >
                    <template #default="scope">
                        <el-tooltip :disabled="isShowTooltip" popper-class="tooltipwidth" :content="scope.row.content"
                                    placement="top">
                            <!-- 单行省略样式、鼠标移入事件 -->
                            <div class="singe-line" @mouseover="onMouseOver($event.target)">{{ scope.row.content }}
                            </div>
                        </el-tooltip>
                    </template>
                </el-table-column>
            ...
            >
                ...
                <el-form-item label="语言类型" prop="langType">
                    <el-select v-model="form.langType" placeholder="请选择" style="width: 100%">
                        <el-option v-for="item in langTypes" :key="item.id" :label="item.name"
                ...
                <el-form-item label="内容" prop="content">
                    <div style="width:100%">
                        <el-upload
                            ...
                            :auto-upload="true"
                            :show-file-list="false">
                            <el-button slot="trigger" size="small" type="primary" @click="doInitPolicy()"></el-button>
                        </el-upload>
                        <QuillEditor ref="quillEditor" contentType="html" class="ql-editor"
                                     style="width:100%;height: 300px" v-model:content="form.content"
        ...
        >
            <div class="details">
                ...
                <div class="details_item">
                    <p class="name">语言类型:</p>
                    <p class="name1"><span v-if="detailObj.langType=='en_US'">英文</span>
...
import Notice from "@/api/request/common/notice";
