  ...
  <div class="app-container">
    ...
    <div class="self-table">
      ...
      >
        ...
        <el-table-column label="参数大类" prop="division" min-width="120px" />
        <el-table-column label="参数类型" prop="type" min-width="120px" />
        <el-table-column label="参数值" prop="value" min-width="140px">
          <template #default="scope">
            <el-tooltip
              :disabled="isShowTooltip"
        ...
        <el-table-column
          ...
          min-width="120px"
        />
        <el-table-column label="参数备注" prop="remark" min-width="120px">
          <template #default="scope">
            <el-tooltip
              :disabled="isShowTooltip"
    ...
    >
      ...
      >
        ...
        <el-form-item label="参数名称" prop="parameterName">
          <el-input v-model="form.parameterName" placeholder="请输入" />
        </el-form-item>
        <el-form-item label="参数大类" prop="division">
          <el-input v-model="form.division" placeholder="请输入" />
        </el-form-item>
        ...
        <el-form-item label="参数值值域" prop="valueBound">
          <el-input v-model="form.valueBound" placeholder="请输入" />
        </el-form-item>
...
import Parameter from "@/hooks/common/parameter";
