    ...
    <div class="app-container">
        ...
        >
            <el-form-item label="版本类型" prop="deviceType">
                <el-select style="width:240px" v-model="queryParams.deviceType" @change="handleQuery"
        ...
        >
            ...
            >
                <el-form-item label="设备类型" prop="deviceType">
                    <el-select style="width:100%" v-model="form.deviceType" @change="handleQuery"
                               placeholder="请选择" clearable>
                        <el-option v-for="(item, index) in deviceList" :key="index" :label="item.name" :value="item.id" />
                    </el-select>
                </el-form-item>
...
import AppVersion from "@/api/request/common/appVersion";
