<template>
    <div class="app-container">
        ...
        <el-row :gutter="10" class="mb8">
            <el-col :span="1.5">
                <el-button type="danger" v-hasPermi="['common:region:operator']" plain size="small" :disabled="multiple"
        ...
        <div class="self-table">
            <el-table size="small" stripe v-loading="loading" ref="pageTableRef" :data="operateList"
                ...
                <el-table-column label="设备名字" prop="deviceName" fixed min-width="120" />
                ...
                <el-table-column label="操作"  min-width="120" fixed="right" class-name="small-padding fixed-width">
                    <template #default="scope">
                        <el-link class="table_link_btn" :underline="false" size="small" type="primary"
                                 v-hasPermi="['common:region:operator']" @click="handleDelete(scope.row)"><span
...
import AppDevice from "@/api/request/common/appDevice";
