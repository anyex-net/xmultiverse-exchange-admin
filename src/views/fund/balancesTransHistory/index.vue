        ...
        >
          <template #default="scope">
              <el-link
                  ...
                  v-hasPermi="['fund:balancesTransHistory:data']"
...
<script lang="ts" name="balancesTransHistory" setup>
import datas from "@/hooks/fund/balancesTransHistory";
import {
  formSearchs,
  titles,
  formOptions,
  formtitles,
  rules,
} from "@/data/fund/balancesTransHistory";
