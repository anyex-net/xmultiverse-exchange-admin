<template>
  <div class="app-container">
    全平台账户浮动累计盈亏<span
      v-html="Number(statisticsModel.profitLoss).toFixed(2)"
    ></span>
    &nbsp;&nbsp;=&nbsp;&nbsp;全平台账户累计余额<span
      v-html="Number(statisticsModel.balance).toFixed(2)"
    ></span>
    &nbsp;&nbsp;-&nbsp;&nbsp;全平台账户累计充值<span
      v-html="Number(statisticsModel.sumDeposit).toFixed(2)"
    ></span>
    &nbsp;&nbsp;-&nbsp;&nbsp;全平台账户累计强增<span
      v-html="Number(statisticsModel.sumAdjustAdd).toFixed(2)"
    ></span>
    &nbsp;&nbsp;+&nbsp;&nbsp;全平台账户累计提现<span
      v-html="Number(statisticsModel.sumWithDraw).toFixed(2)"
    ></span>
    &nbsp;&nbsp;+&nbsp;&nbsp;全平台账户累计强减<span
      v-html="Number(statisticsModel.sumAdjustSub).toFixed(2)"
    ></span>
    <br />
    下游支付平台GP对应的商户余额<span
      v-html="
        Number(
          statisticsModel.sumDeposit * (1 - 0.045) -
            statisticsModel.sumWithDraw * (1 + 0.035)
        ).toFixed(2)
      "
    ></span>
    &nbsp;&nbsp;=&nbsp;&nbsp;全平台账户累计充值<span
...
import monitorAccountProfitLoss from "@/hooks/operation/monitorAccountProfitLoss";
