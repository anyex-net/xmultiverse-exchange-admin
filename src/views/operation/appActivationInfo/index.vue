    ...
    <div class="app-container">
        <el-form size="small" :model="queryParams" ref="queryFormRef" :inline="true" v-show="showSearch"
            ...
            <!-- <el-form-item label="设备编号" prop="deviceId">
              <el-input v-model="queryParams.deviceId" placeholder="请输入" clearable style="width: 240px"
                        @keyup.enter.native="handleQuery()" @change="handleQuery()" />
            </el-form-item> -->
        ...
        <el-row :gutter="10" class="mb8">
            <!-- <el-col :span="1.5">
                <el-button
                    ...
                    size="small"
                    @click="handleAdd"
                    v-hasPermi="['operation:appActivationInfo:operator']"
                >新增
                </el-button
                >
            </el-col>
        ...
        <div class="self-table">
            <el-table size="small" stripe v-loading="loading" ref="pageTableRef" :data="configList"
                ...
                <el-table-column label="设备编号" prop="deviceId" min-width="140px" />
                <el-table-column label="IP地址" prop="ip" min-width="140px" />
                <el-table-column label="来源" prop="source" min-width="140px" />
                ...
                <el-table-column label="操作" fixed="right" min-width="90px" class-name="small-padding fixed-width">
                    ...
                    <template #default="scope">
                        <el-link class="table_link_btn" :underline="false" type="primary"
                            @click="handleUpdate(scope.row)" v-hasPermi="['operation:appActivationInfo:operator']"><span
        ...
        <el-dialog :title="title" v-model="open" width="500px" append-to-body @close="cleanSelect()">
            <el-form size="small" ref="formRef" :model="form" :rules="rules">
                ...
                <el-form-item label="app版本" prop="appVersion" style="font-weight: 600;">
                    <span class="mRbox">{{ form.appVersion }}</span>
                </el-form-item>
                <el-form-item label="设备编号" prop="deviceId" style="font-weight: 600;">
...
<script lang="ts" name="appActivationInfo" setup>
import appActivationInfo from "@/api/request/operation/appActivationInfo/index";
